...
# Task info
expName=u'mother_attach_session1'
...
filename = carpeta+ os.path.sep +'data' + os.path.sep + 'Sub%s_%sSession1' %(expInfo['MotherID'], expInfo['date'])
...
#ventana
win = visual.Window(size=(1280, 800), fullscr=fullScreen, screen=True, allowGUI=False, allowStencil=False,#ventana
